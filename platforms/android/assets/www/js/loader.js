(function() {
    ...
    Z.Je = Y();
    Z.Ea = function(a) { a = a.split(".");
        for (var c = Z.global, d; d = a.shift();)
            if (Z.Nc(c[d])) c = c[d];
            else return null;
        return c };
    Z.Ye = function(a, c) { c = c || Z.global;
    ...
    Z.Eg = !1;
    Z.Gd = !0;
    Z.$c = function(a) { Z.global.console && Z.global.console.error(a) };
    Z.Zf = Y();
    Z.B = "";
    Z.Gf = Y();
    Z.Od = function() {
        throw Error("unimplemented abstract method"); };
    Z.Qd = function(a) { a.Me = function() {
            if (a.ub) return a.ub;
    ...
    Z.$a = "detect";
    Z.mc = "transpile.js";
    Z.Wa && (Z.j = { La: {}, T: {}, F: {}, Ib: {}, Va: {}, X: {} }, Z.sb = function() {
            var a = Z.global.document;
            return null != a && "write" in a }, Z.Fc = function() {
            if (Z.O(Z.global.Mb)) Z.B = Z.global.Mb;
                ...
                for (var a = Z.global.document.getElementsByTagName("SCRIPT"), c = a.length - 1; 0 <= c; --c) {
                    var d = a[c].src,
                        e = d.lastIndexOf("?"),
                        e = -1 == e ? d.length : e;
                    if ("base.js" == d.substr(e - 7, 7)) { Z.B = d.substr(0, e - 7);
                        break } } }, Z.Ga = function(a, c) {
            (Z.global.Ad || Z.xd)(a, c) && (Z.j.Va[a] = !0) }, Z.Wb = !(Z.global.atob || !Z.global.document || !Z.global.document.all),
        Z.Lc = function(a, c, d) { Z.Ga("", 'goog.retrieveAndExec_("' + a + '", ' + c + ", " + d + ");") }, Z.Ra = [], Z.Gg = function(a, c) {
            return Z.Xb && Z.O(Z.global.JSON) ? "goog.loadModule(" + Z.global.JSON.stringify(c + aa + a + "\n") + ");" : 'goog.loadModule(function(exports) {"use strict";' + c + "\n;return exports});\n//# sourceURL=" + a + "\n" }, Z.Yc = function() {
            var a = Z.Ra.length;
            if (0 < a) {
                var c = Z.Ra;
                Z.Ra = [];
                for (var d = 0; d < a; d++) Z.Ab(c[d]) } }, Z.Af = function(a) { Z.wb(a) && Z.rc(a) && Z.Ab(Z.B + Z.Fa(a)) }, Z.wb = function(a) {
            ...
            return !0 }, Z.Ab = function(a) {
            if (a in Z.j.X) {
                var c = Z.j.X[a];
                delete Z.j.X[a];
                Z.Kc(c) } }, Z.zf = Y(), Z.wd = function(a) { Z.global.document.write(ba + a + '">\x3c/script>') }, Z.tc = function(a) {
            ...
            d.defer = !1;
            d.async = !1;
            c.head.appendChild(d) }, Z.xd = function(a, c) {
            if (Z.sb()) {
            ...
            return !!Z.M[a]
        }, Z.M = null, Z.yb = 0, Z.If = function(a, c) { a.readyState == K && Z.yb == c && Z.Yc();
            return !0 }, Z.Hg = function(a) {
            function c(a) {
                if (!(a in f.Va || a in f.Ib)) { f.Ib[a] = !0;
                    if (a in f.F)
                        for (var g in f.F[a])
                            if (!Z.Rc(g))
                                if (g in f.T) c(f.T[g]);
            ...
            return a in Z.j.T ? Z.j.T[a] : null }, Z.Fc(), Z.global.Bd || Z.Ga(Z.B + "deps.js"));
    Z.yf = function(a) {
        var c = Z.l;
        try { Z.l = { Pa: void 0, ua: !1 };
            var d;
            ...
            Z.Zc[e] = d } finally { Z.l = c } };
    Z.Wc = function(a) { eval(a);
        return {} };
    Z.Df = function(a) { a = a.split("/");
    ...
    Z.Vc = function(a) {
        ...
        try {
            ...
            c.open("get", a, !1);
            c.send();
            return 0 == c.status || 200 == c.status ? c.responseText : null } catch (d) {
            return null } };
    Z.$f = Y();
    Z.zg = function(a, c) {
    ...
    Z.u = function(a) {
        ...
        if (c == P)
            if (a) {
                ...
                if ("[object Function]" == d || "undefined" != typeof a.call && "undefined" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable("call")) return N } else return "null";
    ...
    Z.Ze = function(a) {
        return !!a[Z.D] };
    Z.hd = function(a) { null !== a && "removeAttribute" in a && a.removeAttribute(Z.D);
        try { delete a[Z.D] } catch (c) {} };
    ...
    Z.bind = function(a, c, d) { Z.bind = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? Z.wc : Z.vc;
        ...
        if (Z.global.execScript) Z.global.execScript(a, "JavaScript");
            ...
            if (null == Z.Y)
                if (Z.global.eval("var _evalTest_ = 1;"), "undefined" != typeof Z.global._evalTest_) {
                    try { delete Z.global._evalTest_ } catch (e) {}
                    Z.Y = !0 } else Z.Y = !1;
    ...
    Z.ag = function(a, c) { Z.hb = a;
        Z.Bc = c };
    Z.Qe = function(a, c) { c && (a = a.replace(/\{\$([^}]+)}/g, function(a, e) {
            return null != c && e in c ? c[e] : a }));
        return a };
    Z.Re = function(a) {
        return a };
    Z.ya = function(a, c) { Z.xa(a, c, void 0) };
    Z.He = function(a, c, d) { a[c] = d };
    Z.Ha = function(a, c) {
        function d() {}
    ...
    Z.ib = {};
    Z.ib.bc = { Rb: 1, yd: 2, Nd: 3, zd: 4, Id: 5, Hd: 6, Md: 7, Cd: 8, DOCUMENT: 9, Fd: 10, Ed: 11, Kd: 12 };
    Z.b = {};
    Z.b.Xa = !1;
    Z.b.Tb = !1;
    Z.b.pc = { $b: "\u00a0" };
    ...
    Z.b.Db = function(a, c, d) {
        ...
        if (!a) return -1;
        if (!c) return 1;
        for (var e = a.toLowerCase().match(d), f = c.toLowerCase().match(d), g = Math.min(e.length, f.length), h = 0; h < g; h++) { d = e[h];
            var l = f[h];
    ...
    Z.b.Hb = function(a, c) {
        ...
        return a.replace(Z.b.Vb, function(a, c) {
            var f = d[a];
            if (f) return f; "#" == c.charAt(0) && (c = Number("0" + c.substr(1)), isNaN(c) || (f = String.fromCharCode(c)));
    ...
    Z.b.truncate = function(a, c, d) { d && (a = Z.b.Gb(a));
        ...
        d && (a = Z.b.rb(a));
        return a };
    Z.b.Ag = function(a, c, d, e) { d && (a = Z.b.Gb(a));
    ...
    Z.b.$ = { "'": "\\'" };
    Z.b.quote = function(a) { a = String(a);
    ...
    Z.b.jb = function(a) {
        ...
        if (31 < d && 127 > d) c = a;
            ...
            if (256 > d) {
                if (c = "\\x", 16 > d || 256 < d) c += "0" } else c = "\\u", 4096 > d && (c += "0");
    ...
    Z.b.L = function(a, c, d) {
        ...
        return e };
    Z.b.remove = function(a, c) { c = new RegExp(Z.b.Sa(c), "");
        return a.replace(c, "") };
    Z.b.Tf = function(a, c) { c = new RegExp(Z.b.Sa(c), "g");
        return a.replace(c, "") };
    Z.b.Sa = function(a) {
        return String(a).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08") };
    Z.b.repeat = String.prototype.repeat ? function(a, c) {
        return a.repeat(c) } : function(a, c) {
        return Array(c + 1).join(a) };
    Z.b.Jf = function(a, c, d) { a = Z.O(d) ? a.toFixed(d) : String(a);
    ...
    Z.g.A = function(a, c, d, e) {
        ...
        a = new Z.g.V("" + f, g || []);
        Z.g.va(a) };
    Z.g.cg = function(a) { Z.g.s && (Z.g.va = a) };
    Z.g.assert = function(a, c, d) { Z.g.s && !a && Z.g.A("", null, c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Aa = function(a, c) { Z.g.s && Z.g.va(new Z.g.V("Failure" + (a ? ": " + a : ""), Array.prototype.slice.call(arguments, 1))) };
    Z.g.Wd = function(a, c, d) { Z.g.s && !Z.Qc(a) && Z.g.A("Expected number but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Zd = function(a, c, d) { Z.g.s && !Z.h(a) && Z.g.A("Expected string but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Ud = function(a, c, d) { Z.g.s && !Z.xb(a) && Z.g.A("Expected function but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Xd = function(a, c, d) { Z.g.s && !Z.P(a) && Z.g.A("Expected object but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Rd = function(a, c, d) { Z.g.s && !Z.isArray(a) && Z.g.A("Expected array but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Sd = function(a, c, d) { Z.g.s && !Z.Mc(a) && Z.g.A("Expected boolean but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Td = function(a, c, d) {!Z.g.s || Z.P(a) && a.nodeType == Z.ib.bc.Rb || Z.g.A("Expected Element but got %s: %s.", [Z.u(a), a], c, Array.prototype.slice.call(arguments, 2));
        return a };
    Z.g.Vd = function(a, c, d, e) {!Z.g.s || a instanceof c || Z.g.A("Expected instanceof %s but got %s.", [Z.g.pb(c), Z.g.pb(a)], d, Array.prototype.slice.call(arguments, 3));
        return a };
    Z.g.Yd = function() {
    ...
    Z.f.indexOf = Z.w && (Z.f.v || Array.prototype.indexOf) ? function(a, c, d) {
        return Array.prototype.indexOf.call(a, c, d) } : function(a, c, d) { d = null == d ? 0 : 0 > d ? Math.max(0, a.length + d) : d;
    ...
    Z.f.lastIndexOf = Z.w && (Z.f.v || Array.prototype.lastIndexOf) ? function(a, c, d) {
        return Array.prototype.lastIndexOf.call(a, c, null == d ? a.length - 1 : d) } : function(a, c, d) { d = null == d ? a.length - 1 : d;
        0 > d && (d = Math.max(0, a.length + d));
        if (Z.h(a)) return Z.h(c) && 1 == c.length ? a.lastIndexOf(c, d) : -1;
        for (; 0 <= d; d--)
            if (d in a && a[d] === c) return d;
        return -1 };
    Z.f.forEach = Z.w && (Z.f.v || Array.prototype.forEach) ? function(a, c, d) { Array.prototype.forEach.call(a, c, d) } : function(a, c, d) {
    ...
    Z.f.filter = Z.w && (Z.f.v || Array.prototype.filter) ? function(a, c, d) {
        return Array.prototype.filter.call(a, c, d) } : function(a, c, d) {
    ...
    Z.f.map = Z.w && (Z.f.v || Array.prototype.map) ? function(a, c, d) {
        return Array.prototype.map.call(a, c, d) } : function(a, c, d) {
        for (var e = a.length, f = Array(e), g = Z.h(a) ? a.split("") : a, h = 0; h < e; h++) h in g && (f[h] = c.call(d, g[h], h, a));
        return f };
    Z.f.reduce = Z.w && (Z.f.v || Array.prototype.reduce) ? function(a, c, d, e) { e && (c = Z.bind(c, e));
        return Array.prototype.reduce.call(a, c, d) } : function(a, c, d, e) {
        var f = d;
        Z.f.forEach(a, function(d, h) { f = c.call(e, f, d, h, a) });
        return f };
    Z.f.reduceRight = Z.w && (Z.f.v || Array.prototype.reduceRight) ? function(a, c, d, e) { e && (c = Z.bind(c, e));
        return Array.prototype.reduceRight.call(a, c, d) } : function(a, c, d, e) {
        var f = d;
        Z.f.kb(a, function(d, h) { f = c.call(e, f, d, h, a) });
        return f };
    Z.f.some = Z.w && (Z.f.v || Array.prototype.some) ? function(a, c, d) {
        return Array.prototype.some.call(a, c, d) } : function(a, c, d) {
    ...
    Z.f.every = Z.w && (Z.f.v || Array.prototype.every) ? function(a, c, d) {
        return Array.prototype.every.call(a, c, d) } : function(a, c, d) {
        for (var e = a.length, f = Z.h(a) ? a.split("") : a, g = 0; g < e; g++)
            if (g in f && !c.call(d, f[g], g, a)) return !1;
        return !0 };
    Z.f.count = function(a, c, d) {
        var e = 0;
        Z.f.forEach(a, function(a, g, h) { c.call(d, a, g, h) && ++e }, d);
        return e };
    Z.f.find = function(a, c, d) { c = Z.f.findIndex(a, c, d);
        return 0 > c ? null : Z.h(a) ? a.charAt(c) : a[c] };
    Z.f.findIndex = function(a, c, d) {
        for (var e = a.length, f = Z.h(a) ? a.split("") : a, g = 0; g < e; g++)
            if (g in f && c.call(d, f[g], g, a)) return g;
        return -1 };
    Z.f.Ie = function(a, c, d) { c = Z.f.Gc(a, c, d);
        return 0 > c ? null : Z.h(a) ? a.charAt(c) : a[c] };
    ...
    Z.f.clear = function(a) {
        ...
        a.length = 0 };
    Z.f.bf = function(a, c) { Z.f.contains(a, c) || a.push(c) };
    Z.f.tb = function(a, c, d) { Z.f.splice(a, d, 0, c) };
    Z.f.cf = function(a, c, d) { Z.dd(Z.f.splice, a, d, 0).apply(null, c) };
    Z.f.insertBefore = function(a, c, d) {
        var e;
        2 == arguments.length || 0 > (e = Z.f.indexOf(a, d)) ? a.push(c) : Z.f.tb(a, c, e) };
    Z.f.remove = function(a, c) { c = Z.f.indexOf(a, c);
        var d;
        (d = 0 <= c) && Z.f.L(a, c);
        return d };
    Z.f.Yf = function(a, c) { c = Z.f.lastIndexOf(a, c);
        return 0 <= c ? (Z.f.L(a, c), !0) : !1 };
    Z.f.L = function(a, c) {
        return 1 == Array.prototype.splice.call(a, c, 1).length };
    Z.f.Xf = function(a, c, d) { c = Z.f.findIndex(a, c, d);
        return 0 <= c ? (Z.f.L(a, c), !0) : !1 };
    Z.f.Uf = function(a, c, d) {
        var e = 0;
        Z.f.kb(a, function(f, g) { c.call(d, f, g, a) && Z.f.L(a, g) && e++ });
        return e };
        ...
        for (var d = 1; d < arguments.length; d++) {
            ...
            if (Z.Ia(e)) {
                var f = a.length || 0,
                    g = e.length || 0;
                a.length = f + g;
                for (var h = 0; h < g; h++) a[f + h] = e[h] } else a.push(e) } };
    ...
    Z.f.ld = function(a, c, d) {
        ...
        Z.f.sort(a, function(a, d) {
            return e(c(a), c(d)) }) };
    Z.f.gg = function(a, c, d) { Z.f.ld(a, function(a) {
            return a[c] }, d) };
    Z.f.sf = function(a, c, d) { c = c || Z.f.C;
    ...
    Z.f.Fe = function(a, c, d) {
        ...
        return !0 };
    Z.f.xe = function(a, c, d) { d = d || Z.f.C;
    ...
    Z.f.Cc = function(a, c) {
        return a === c };
    Z.f.$d = function(a, c, d) { d = Z.f.cb(a, c, d);
        return 0 > d ? (Z.f.tb(a, c, -(d + 1)), !0) : !1 };
    Z.f.fe = function(a, c, d) { c = Z.f.cb(a, c, d);
    ...
    Z.f.wg = function(a, c, d) {
        var e = {};
        Z.f.forEach(a, function(f, g) { e[c.call(d, f, g, a)] = f });
        return e };
    ...
    Z.f.Hc = function(a) {
        ...
        return c };
    Z.f.rotate = function(a, c) { a.length && (c %= a.length, 0 < c ? Array.prototype.unshift.apply(a, a.splice(-c, c)) : 0 > c && Array.prototype.push.apply(a, a.splice(0, -c)));
        return a };
    Z.f.Cf = function(a, c, d) { c = Array.prototype.splice.call(a, c, 1);
    ...
    Z.f.Ig = function(a) {
        ...
        for (e = 0; e < d; e++) {
            ...
            c.push(f) }
        return c };
    Z.f.fg = function(a, c) { c = c || Math.random;
    ...
    Z.f.Ae = function(a, c) {
        var d = [];
        Z.f.forEach(c, function(c) { d.push(a[c]) });
        return d };
    ...
    Z.locale.dg = function(a) { a = a.replace(/-/g, "_");
        Z.locale.N = a };
    Z.locale.Da = function() { Z.locale.N || (Z.locale.N = "en");
        return Z.locale.N };
    Z.locale.H = { Dd: "DateTimeConstants", Ld: "NumberFormatConstants", ic: "TimeZoneConstants", Yb: ka, jc: "TimeZoneSelectedIds", lc: "TimeZoneSelectedShortNames", kc: "TimeZoneSelectedLongNames", hc: "TimeZoneAllLongNames" };
    ...
    Z.locale.We = function(a) { a = a.split(/[-_]/g);
    ...
    Z.locale.Oe = function(a, c) { c || (c = Z.locale.ob());
        var d = Z.locale.mb(a);
    ...
    Z.locale.Pe = function(a, c) { c || (c = Z.locale.ob());
    ...
    Z.locale.m = {};
    Z.locale.Pf = function(a, c) { Z.locale.K(a, Z.locale.H.ic, c) };
    Z.locale.Nf = function(a, c) { Z.locale.K(a, Z.locale.H.Yb, c) };
    Z.locale.Qf = function(a, c) { Z.locale.K(a, Z.locale.H.jc, c) };
    Z.locale.Sf = function(a, c) { Z.locale.K(a, Z.locale.H.lc, c) };
    Z.locale.Rf = function(a, c) { Z.locale.K(a, Z.locale.H.kc, c) };
    Z.locale.Of = function(a, c) { Z.locale.K(a, Z.locale.H.hc, c) };
    Z.locale.ob = function() {
        var a = Z.locale.Da(),
            a = a ? a : Z.locale.Da();
        if (ka in Z.locale.m) return Z.locale.m.LocaleNameConstants[a] };
    Z.locale.Ve = function(a, c) { c = c ? c : Z.locale.Da();
        if (a in Z.locale.m) {
    ...
    google.a.c.vd = { 1: "1.0", "1.0": "current", "1.1": "upcoming", current: "45", upcoming: "45", 41: "top", 42: "top", 43: "top", 44: "top" };
    ...
    google.a.c.pd = { d3: "d3/d3.js", "d3.sankey": "d3/d3.sankey.js", webfontloader: "webfontloader/webfont.js" };
    ...
    google.a.c.ra = function(a, c) { c = c || {};
    ...
    google.a.c.zb = function(a, c, d) { google.a.c.log("loadScript: " + a);
    ...
    google.a.c.Xc = function(a, c) {
        ...
        if (0 === a.length) c();
            ...
            google.a.c.cd = function(a, c) { google.a.c.log("callback after loading " + a);
                D[a] = c;
                google.a.c.R[a] = !0;
                ya--;
                0 === ya && ob() };
    ...
    google.a.c.W = function(a) {
        ...
        var l = "load-css-" + google.a.c.W.count++,
            m = { done: function(a) { e.push(a);
                    g && a();
                    return m }, Aa: function(a) { f.push(a);
                    h && a();
                    return m } },
        ...
        "undefined" !== typeof n.addEventListener ? (n.addEventListener("load",
            ...
            try {
                for (; e--;)
                    if (a = document.styleSheets[e], a.id === l) { c();
                        return } } catch (ya) {}
            g || d() });
    ...
    google.a.c.Tc = function(a, c) { google.a.c.log("loadCSSFile: " + a);
        google.a.c.W(a).done(c).Aa(function() { google.a.c.error("loading css failed: " + a) }) };
    ...
    google.a.c.Cb = function(a) {
        ...
        return a };
    google.a.c.fd = function(a, c) { c.log && (google.a.c.log = c.log);
    ...
    google.a.c.load = function(a, c, d) {
        if (google.a.c.S) google.a.c.U(function() { google.a.c.load(a, c, d) });
            ...
            if (null == e) f = function() {
                ...
                google.a.c.Uc(h, function() { google.a.c.Xc(h, g) })
            }
        }
    };
    ...
    google.a.c.kd(function() { google.a.c.Jb = !0;
        google.a.c.Na() });
    google.a.c.Na = function() {!google.a.c.S && google.a.c.Jb && google.a.c.xc() };
    google.a.c.Ba = [];
    google.a.c.U = function(a) { a && google.a.c.Ba.push(a);
        google.a.c.S || google.a.c.Na() };
    google.a.c.xc = function() {
        var a = google.a.c.Ba;
        for (google.a.c.Ba = []; 0 < a.length;) a.shift()() };
    google.a.c.Qa = function(a, c) { google.a.c.cd(a, c) };
    if (Z.Ea(Xa)) throw Error("Google Charts loader.js can only be loaded once.");
    google.a.load = function() {
        var a = 0; "visualization" === arguments[a] && a++;
        var c = "current";
    ...
    google.a.U = function(a) { google.a.c.U(a) };
